...
<div id="veiculoModal" class="modal">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form id="veiculoForm">
        <div class="form-row"><div class="form-group"><label for="veiculoClienteBusca">Cliente *</label><input type="text" id="veiculoClienteBusca" placeholder="Digite nome ou telefone" autocomplete="off" required><input type="hidden" id="veiculoCliente"><datalist id="veiculoClienteDatalist"></datalist><small style="display:block;margin-top:6px;color:#6b7280;">Não encontrou o cliente? <a href="#" onclick="openVeiculoClientePreCadastro(event)">Cadastrar agora</a></small></div></div>
        <div class="form-row">
