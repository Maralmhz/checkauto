// INJEÇÃO DE MODALS DIRETO NO HTML (SEM FETCH)
(function() {
    const modalsHTML = `
<!-- MODAL CLIENTE -->
            ...
            <form id="clienteForm">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="clienteCPF" data-mask="cpf-cnpj">
                    </div>
                    <div class="form-group">
                        <label for="clienteTelefone">Telefone *</label>
                        <input type="text" id="clienteTelefone" data-mask="phone" required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="clienteEndereco">Endereço Completo</label>
            ...
            <form id="veiculoForm">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="veiculoCliente" required>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="veiculoPlaca" maxlength="8" style="text-transform: uppercase;" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="veiculoChassis">Chassis</label>
                        <input type="text" id="veiculoChassis">
                    </div>
                    <div class="form-group">
                        <label for="veiculoAno">Ano</label>
                        <input type="text" id="veiculoAno" maxlength="9" placeholder="Ex: 2020/2021">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
            ...
            <form id="osForm">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="osCliente" onchange="atualizarVeiculosOS()" required>
                            <option value="">Selecione um cliente</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="osVeiculo">Veículo *</label>
                        <select id="osVeiculo" required disabled>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="osDescricao">Descrição do Serviço *</label>
                        <textarea id="osDescricao" rows="4" required></textarea>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="osValor">Valor Total (R$)</label>
                        <input type="text" id="osValor" placeholder="0,00" data-mask="money">
                    </div>
                </div>
            </form>
        </div>
            ...
            <form id="agendamentoForm">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="agendamentoCliente" onchange="atualizarVeiculosAgendamento()" required>
                            <option value="">Selecione um cliente</option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="agendamentoVeiculo" required disabled>
                            <option value="">Selecione um veículo</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="agendamentoServico" required>
                    </div>
                </div>
            </form>
        </div>
...
.modal-content { background-color: white; border-radius: 8px; width: 90%; max-width: 600px; max-height: 90vh; overflow-y: auto; animation: slideDown 0.3s; box-shadow: 0 4px 20px rgba(0,0,0,0.2); }
.modal-content.modal-large { max-width: 900px; }
.modal-header { padding: 20px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; display: flex; justify-content: space-between; align-items: center; border-radius: 8px 8px 0 0; }
.modal-header h3 { margin: 0; font-size: 1.5em; }
.modal-header .close { font-size: 28px; font-weight: bold; cursor: pointer; background: rgba(255,255,255,0.2); width: 35px; height: 35px; display: flex; align-items: center; justify-content: center; border-radius: 50%; transition: all 0.3s; }
.modal-header .close:hover { background: rgba(255,255,255,0.3); transform: rotate(90deg); }
.modal-body { padding: 30px; }
.modal-footer { padding: 20px; background: #f8f9fa; display: flex; justify-content: flex-end; gap: 10px; border-radius: 0 0 8px 8px; }
@keyframes fadeIn { from { opacity: 0; } to { opacity: 1; } }
@keyframes slideDown { from { transform: translateY(-50px); opacity: 0; } to { transform: translateY(0); opacity: 1; } }
@media (max-width: 768px) { .modal-content { width: 95%; margin: 20px; } .modal-body { padding: 20px; } }
</style>
`;

    document.body.insertAdjacentHTML('beforeend', modalsHTML);
    console.log('✅ Modals injetados com sucesso!');
})();